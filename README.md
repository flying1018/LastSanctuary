...
<details> **플레이어, 적, 보스 리지드 바디 타입을 Dynamic → Kinematic으로 변경**
...
![image.png](attachment:9217553e-13a7-401b-8b8d-02f565dee0fc:image.png)
...
- **인터페이스 방식 FSM 구조를 활용한 다양한 기능 구현(플레이어, 적, 보스, UI)**
    - **장점** :
        - 높은 유연성과 확장성
        - 낮은 결합도(Low Coupling)
        - 코드의 재사용성 및 가독성
...
- **게임 흐름도**
    ...
    ![image.png](attachment:e0d41a59-81d8-402d-9033-efa7cf9f8bab:image.png)
    
- **Kinematic 이동 관련 구조**
    
    ![image.png](attachment:6d914cd9-c2a2-4987-b93b-4c7287c1b41c:image.png)
    
- **플레이어 상태 머신**
    
    ![image.png](attachment:508a5c79-030f-4788-92b7-3f481dd7132c:image.png)
    
- **적 상태 머신**
    
    ![image.png](attachment:76ba061b-11dd-4445-b700-2e1ff6b3d150:image.png)
    
- **보스 상태 머신**
    
    ![image.png](attachment:681520c4-ee31-4069-b510-2dd0d5d77b7b:image.png)
...
- **UI 상태 머신**
    ...
    ![image.png](attachment:77252e6e-c9ba-4837-8344-dccade6e975b:image.png)
...
- **무기 구조**
    ...
    ![image.png](attachment:5dc7ea2d-bb57-4ebd-8453-d5428954f2a7:image.png)
    
    - 뒤늦게 확인해보니 BossWeapon과 EnemyWeapon의 코드가 같음.
    - 아마도 초기에는 매개변수를 다양하게 전달하여서 분리하였으나, 지금은 WeaponInfo에 넣어서 보내서 생긴 문제인듯 함.
- **피해 입는 구조**
    
    ![image.png](attachment:9c71cf0f-2275-43a9-a22d-080558e6e68a:image.png)
    
    - 모든 컨디션은 컨디션을 상속받고 거기에 필요한 인터페이스를 상속 받는 방식
- **아이템 구조**
    
    ![image.png](attachment:0add356e-4830-4c5c-9734-13cdf614ca8d:image.png)
    
- **맵 오브젝트 구조**
    
    ![image.png](attachment:0d6528ab-3ed9-41d4-9f99-8b50690df865:image.png)
...
| 팀원 | 담당 기능 | 코드 Github |
| --- | --- | --- |
| 이준영, 안상진 | **FSM구조를 활용한 Player,Enemy,Boss,UI** | https://github.com/leejy1685/LastSanctuary_Code/tree/main/FSM%EA%B5%AC%EC%A1%B0%EB%A5%BC%20%ED%99%9C%EC%9A%A9%ED%95%9C%20Player%2CEnemy%2CBoss%2CUI |
...
[Team ](https://www.notion.so/24d2dc3ef51480e3bf52f98b86e46caf?pvs=21)
